...
function initCapabilityStatement() {
    ...
    generatePDFBtn.addEventListener('click', async function () {
        ...
        let previewModal = document.getElementById('capability-preview-modal');
        if (!previewModal) {
            previewModal = document.createElement('div');
            previewModal.className = 'modal-overlay';
            previewModal.id = 'capability-preview-modal';
            previewModal.innerHTML = `
                <div class="modal-content">
                    <div class="modal-header">
                        <h2>Capability Statement Preview</h2>
                        <button class="modal-close" data-modal="capability-preview-modal" aria-label="Close Preview">
                            <i class="fas fa-times"></i>
                        </button>
                    </div>
                    <div class="modal-body">
                        <div id="capability-preview-container"></div>
                    </div>
                    <div class="modal-footer">
                        <button id="close-capability-preview" class="btn btn-secondary">Close</button>
                        <button id="download-capability-pdf" class="btn btn-primary">
            ...
            // Add event listeners
            const closeButtons = previewModal.querySelectorAll('.modal-close, #close-capability-preview');
        ...
        try {
            ...
            const capabilityData = {
                ...
                contactName: "Mathew Harvey",
                contactEmail: "mharvey@franmarine.com.au",
                contactPhone: "+61 408 930 300",
            ...
            const previewContainer = document.getElementById('capability-preview-container');
            ...
            const downloadButton = document.getElementById('download-capability-pdf');
            ...
            console.error("Error generating preview:", error);
            alert("Failed to generate preview. Please try again or contact support if the issue persists.");
            // Reset button state
            generatePDFBtn.disabled = false;
            generatePDFBtn.innerHTML = originalText;
        }
